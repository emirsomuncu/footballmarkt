...
public class ArenaGamesController {
    ...
    @PostMapping("/create")
    public ResponseEntity<ApiResponse> createArenaGame(@RequestParam(required = false) Long clubId , @RequestParam(required = false) Long leagueId) {
    ...
    @PostMapping("/play")
    public ResponseEntity<ApiResponse> playArenaGame(@RequestParam Long arenaGameId , @RequestParam Long playerId) {
    ...
    public ResponseEntity<ApiResponse> deleteArenaGame(@RequestParam Long arenaGameId) {

...
public class NewsController {
    ...
    @GetMapping("/all")
    public ResponseEntity<ApiResponse> getAllNews(@RequestParam(defaultValue = "0") int pagingOffset) {
    ...
    @PostMapping("/add")
    public ResponseEntity<ApiResponse> createNews(@RequestBody CreateNewsRequest createNewsRequest) {
    ...
    @PutMapping("/update")
    public ResponseEntity<ApiResponse> createNews(@RequestBody UpdateNewsRequest updateNewsRequest) {

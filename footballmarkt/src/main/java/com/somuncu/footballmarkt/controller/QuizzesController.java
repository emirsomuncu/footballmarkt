...
public class QuizzesController {
    ...
    @GetMapping("/all")
    public ResponseEntity<ApiResponse> getAllQuizzes(@RequestParam int pagingOffset) {
    ...
    public ResponseEntity<ApiResponse> getQuizzesByUserName(@PathVariable String userName  , @AuthenticationPrincipal UserDetails userDetails ) {
    ...
    @PostMapping("/create")
    public ResponseEntity<ApiResponse> createQuiz(@RequestBody CreateQuizRequest createQuizRequest ,@AuthenticationPrincipal UserDetails userDetails) {
    ...
    @PutMapping("/solve")
    public ResponseEntity<ApiResponse> solveQuiz(@RequestParam Long quizId , @RequestBody SolveQuizRequest solveQuizRequest, @AuthenticationPrincipal UserDetails userDetails) {
    ...
    public ResponseEntity<ApiResponse> deleteQuiz(@RequestParam Long id , @AuthenticationPrincipal UserDetails userDetails) {

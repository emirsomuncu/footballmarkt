...
public class TrophiesController {
    ...
    @GetMapping("/{name}")
    public ResponseEntity<ApiResponse> getTrophyByName(@PathVariable String name) {
    ...
    @GetMapping("/trophy")
    public ResponseEntity<ApiResponse> getTrophyBySeasonAndLeague(@RequestParam String season , @RequestParam String leagueName) {
    ...
    public ResponseEntity<ApiResponse> getLeagueTrophies(@PathVariable String leagueName) {
    ...
    public ResponseEntity<ApiResponse> getClubTrophies(@PathVariable String clubName) {
    ...
    @PostMapping("/create")
    public ResponseEntity<ApiResponse> createTrophy(@RequestBody CreateTrophyRequest createTrophyRequest) {
    ...
    @PutMapping("/update")
    public ResponseEntity<ApiResponse> updateTrophy(@RequestBody UpdateTrophyRequest updateTrophyRequest) {
    ...
    public ResponseEntity<ApiResponse> deleteTrophy(@PathVariable Long id) {
